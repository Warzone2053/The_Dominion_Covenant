...
4.  **Appointment and Confirmation of Provincial Judges:**
    ...
    (f) **Ratification by the Citizen's Oversight Tribune:** The formal nomination shall be transmitted to the Active Council of the Citizen's Oversight Tribune for final ratification. The following protocol is mandatory:
        i. **Accountability Clock:** The Active Council has a fixed period of 120 days from the date of receipt to conduct a ratification vote.
        ii. **Successful Ratification:** A nominee is ratified upon receiving the approval of a two-thirds supermajority of the Active Council.
        iii. **Rejection:** A nominee is considered rejected if they fail to secure the required supermajority in a formal vote, or if the 120-day period expires without a vote being held (rejection by default). In the case of a rejection by default, the Active Council is constitutionally required to publish, within seven days, a formal public report detailing the reasons for its failure to vote.
    (g) **Forced Dialogue Protocol for Rejected Nominees:**
        i. **First Rejection:** Following the first rejection, the provincial executive is obligated to select a different candidate from the legislature's confirmed list within 30 days. This nominee is then transmitted to the Active Council.
        ii. **Accelerated Subsequent Review:** For this second nominee, and any subsequent nominee from the same list, the ratification period for the Active Council shall be reduced to **60 days**.
        iii. **Voiding of the List:** If all candidates on the confirmed list are ultimately rejected, the process shall proceed according to clause (h).
    (h) **Resolution of a Voided List and the Integrity Shield:**
        i. **Standard Reset:** If an entire list is rejected, the Provincial Judicial Council shall typically produce a new list of not less than three and not more than five different nominees within 90 days, and the entire appointment and confirmation process shall begin again from step (c).
        ii. **Judicial Integrity Shield:** However, if the Council determines by a **unanimous vote** that its list of qualified nominees was rejected for frivolous or politically motivated reasons, it may instead issue a **"Declaration of Procedural Integrity."** Upon issuing this declaration, the Council is constitutionally required to **publish a comprehensive public report** detailing the qualifications of every candidate on its rejected list and the evidence supporting its determination of bad-faith rejection. This declaration triggers the following final appointment protocol:
            (a) The provincial executive is obligated to select one final nominee from the previously rejected list within 15 days.
            (b) This nominee shall be considered ratified unless the Active Council can muster a **three-quarters (75%) supermajority** to reject them within 60 days. The decision of this final vote is absolute.
...
### ARTICLE VI: NATIONAL SECURITY AND COMMERCE

1.  **Power of National Security Review:** To protect the sovereignty, security, and essential viability of the nation, the federal legislature is empowered to pass laws establishing a "National Security Review" for foreign acquisitions of Canadian businesses and real property.

2.  **Limited Scope:** This review shall be strictly limited to foreign acquisitions of businesses or property operating in the following, and only the following, strategic sectors:
    (a) National Defense and Armaments.
    (b) Critical Infrastructure, including power generation and transmission, telecommunications networks, and major ports.
    (c) **Information Infrastructure and Technology,** including large-scale data processing centers, social media platforms with a substantial domestic user base, and developers of artificial intelligence.
    (d) **Essential National Resources,** including mineral and energy operations, significant agricultural land holdings, and major freshwater sources.

3.  **Test for Prohibition:** A foreign acquisition subject to this review may only be blocked upon a formal and public finding by the executive branch that the transaction poses a direct and credible threat to the **sovereignty, physical security, or essential viability of the nation.** A threat to essential viability includes attempts to gain control over a significant portion of the nation's food supply, energy resources, or critical information ecosystem. Economic protectionism shall not be sufficient grounds for prohibition.

4.  **Judicial Review:** Any decision to block an acquisition under this Article shall be subject to appeal in the federal courts to ensure the government has acted within its constitutional authority.